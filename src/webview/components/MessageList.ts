...
/**
 * Generate script for auto-scroll functionality (T044)
 * This script should be included in the page to enable auto-scroll
 */
export function MessageListScript(): string {
	return `
		<script>
			(function() {
				...
				const observer = new MutationObserver((mutations) => {
					// Check if we were already near the bottom before mutation
					const wasAtBottom = messageList && 
				...
				// Export scroll function for manual use
